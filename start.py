    ...
    if cas:
        ...
        for ca in ca_list:
            if "-----END CERTIFICATE-----" in ca:
                ...
                os.system('.local/usr/lib/jvm/AdoptOpenJDK-jdk-11.0.3-AdoptOpenJDK-x64/bin/keytool -import -trustcacerts -file .local/certificate_authorities.0.crt -keystore .local/usr/lib/jvm/AdoptOpenJDK-jdk-11.0.3-AdoptOpenJDK-x64/lib/security/cacerts -storepass changeit -alias extCert -noprompt')
